 ...
 */
public final class InterlisDocumentSymbolCollector {
    private final String documentText;

    public InterlisDocumentSymbolCollector(String documentText) {
        this.documentText = documentText != null ? documentText : "";
    }

    public List<DocumentSymbol> collect(TransferDescription td) {
        if (td == null) {
